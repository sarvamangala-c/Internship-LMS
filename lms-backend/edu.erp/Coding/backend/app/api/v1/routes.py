...
from app.api.v1.conso_absentees_report.cons_absentees_report_routes import router as cons_absentees_router
from app.api.v1.reports import router as consolidated_student_marks_router
...
router.include_router(
    topic_routes.router, prefix="/topic_management"
)
...
# router.include_router(
#     cons_absentees_router,
#     prefix="/conso_absentees_report",
#     tags=["Consolidated Absentees Report"]
# )
